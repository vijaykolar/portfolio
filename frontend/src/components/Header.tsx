...
function ModeToggle() {
  ...
  function toggleMode() {
    ...
    if (isDarkMode === isSystemDarkMode) {
      delete (window.localStorage as Storage & { isDarkMode?: string }).isDarkMode
    } else {
        ...
        {isHomePage && (
          <>
            ...
            <Container
              ...
              style={{ position: 'var(--header-position)' as 'sticky' | 'relative' }}
            >
              <div
                className="top-[var(--avatar-top,theme(spacing.3))] w-full"
                style={{ position: 'var(--header-inner-position)' as 'fixed' | 'static' }}
              >
